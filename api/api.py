...
def get_db_connection():
    try:
        conn = psycopg2.connect(
            host=os.environ['FUNGIDB_HOST'],
            dbname=os.environ['FUNGIDB_NAME'],
            user=os.environ['FUNGIDB_USERNAME'],
            password=os.environ['FUNGIDB_PASSWORD'])
    except:
        print("Craaaap. The database connection didn't work")
...
def get_current_time():
    try:
        ...
        print('Problem fetching DB info for /time')
